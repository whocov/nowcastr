...
[![R
version](https://img.shields.io/badge/R-%3E%3D4.1.0-blue.svg)](https://www.r-project.org/)
...
More detailed examples are available in the [Getting
started](https://whocov.github.io/nowcastr/articles/nowcastr.html)
vignette.
...
[`nowcast_cl()`](https://whocov.github.io/nowcastr/reference/nowcast_cl.md)
returns an S7 object of class `nowcast_results` with the following slots
(access with `@`):
