...
Here the different reporting dates are encoded into different lines with different colors. 
...
Depending on your data and use case, you may or may not want to fill missing values with the last known reported value.
